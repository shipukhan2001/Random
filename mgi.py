...
class create:
    ...
    def scrap1(self):
        try:
            ...
            url1 = f'https://www.instagram.com/'
            ...
            cok += perangkat
            pos1 = self.r_fb.post(f'https://www.instagram.com/?cid={cid}',headers=self.head1,data=dat,cookies={'cookie':cok})
    ...
    def scrap2(self,raq1):
        try:
            ...
            nek  = 'https://www.instagram.com/' + raq1['action']
            cok  = '; '.join([str(x)+"="+str(y) for x,y in self.r_fb.cookies.get_dict().items()])
            cok += perangkat
    ...
    def scrap3(self,pos3,gui):
        try:
            if gui == '1':
                ...
                nek = 'https://www.instagram.com/' + nok
                cok  = '; '.join([str(x)+"="+str(y) for x,y in self.r_fb.cookies.get_dict().items()])
                cok += perangkat
                ...
                nek = 'https://www.instagram.com/' + raq3['action']
                cok = '; '.join([str(x)+"="+str(y) for x,y in self.r_fb.cookies.get_dict().items()])
                cok += perangkat
    ...
    def scrap4(self,pos4):
        try:
            ...
            nek  = 'https://www.instagram.com/' + raq4['action']
            cok  = '; '.join([str(x)+"="+str(y) for x,y in self.r_fb.cookies.get_dict().items()])
            cok += perangkat
    ...
    def scrap5(self,pos5):
        try:
            ...
            nuk  = 'https://www.instagram.com/' + raq6['action']
            cok  = '; '.join([str(x)+"="+str(y) for x,y in self.r_fb.cookies.get_dict().items()])
            cok += perangkat
    ...
    def profil(self):
        try:
            ...
            url = 'https://www.instagram.com/profile_picture/'
    ...
    def cover(self):
        try:
            fot = urllib.request.urlopen(self.foto)
            url = 'https://www.instagram.com/photos/upload/?cover_photo'
            req = bs(self.xyz.get(url,cookies=self.cookie,headers=self.head1).content,'html.parser')
            raq = req.find('form',{'method':'post'})
            dat = {
                'fb_dtsg'                  : re.search('name="fb_dtsg" type="hidden" value="(.*?)"',str(raq)).group(1),
                ...
                'submit'                   : 'Unggah'}
            fil = {'file1' : fot}
            pos = bs(self.xyz.post('https://www.instagram.com/'+raq['action'],data=dat,files=fil,cookies=self.cookie,headers=self.head1).content,'html.parser')
        except Exception as e:
            pass
    ...
    def bio(self):
        try:
            url = 'https://www.instagram.com/profile/basic/intro/bio/'
            req = bs(self.xyz.get(url,cookies=self.cookie,headers=self.head1).content,'html.parser')
            raq = req.find('form',{'method':'post'})
            dat = {
                'fb_dtsg'         : re.search('name="fb_dtsg" type="hidden" value="(.*?)"',str(raq)).group(1),
                ...
                'submit'          : 'Simpan'}
            pos = bs(self.xyz.post('https://www.instagram.com/'+raq['action'],data=dat,cookies=self.cookie,headers=self.head1).content,'html.parser')
        except Exception as e:
            pass
    ...
    def auto_follow(self):
        ...
        for x in acc:
            url = f'https://www.instagram.com/profile.php?id={x}'
            try:
                req = bs(self.xyz.get(url,cookies=self.cookie,headers=self.head1).content,'html.parser')
                raq = req.find('a',string='Ikuti')
                get = self.xyz.get('https://www.instagram.com/'+raq['href'],cookies=self.cookie,headers=self.head1)
            except Exception as e:
                pass
    ...
    def website(self):
        try:
            url = 'https://www.instagram.com/editprofile.php?type=contact&edit=website'
            req = bs(self.xyz.get(url,cookies=self.cookie,headers=self.head1).content,'html.parser')
            raq = req.find('form',{'method':'post'})
            dat = {
                'fb_dtsg'    : re.search('name="fb_dtsg" type="hidden" value="(.*?)"',str(raq)).group(1),
    ...
    def logout(self):
        global ok, cp
        try:
            req = bs(self.xyz.get('https://www.instagram.com/',cookies=self.cookie,headers=self.head1).content,'html.parser')
...
class menu_check:
    ...
    def check(self,daf):
        try: 
            ...
            url = f'https://www.instagram.com/profile.php?id={id}'
