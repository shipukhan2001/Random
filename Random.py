...
| '--------------' || '--------------' |
 '----------------'  '----------------' 
\33[1;33mâ• â•â•[Dark Web:        : MR.SHIPU
\33[1;33mâ• â•â•[FACEBOOK      : SHIPU KHAN
\33[1;33mâ• â•â•[GITHUB            : SK-999
\33[1;33mâ• â•â•[REGIONAL       : Afghanistan
\33[1;33mâ• â•â•[TOOLS         : PAID
\33[1;33mâ• â•â•[VERSION       : 4.0'''''')  
def lines():
	print('\33[1;37m----------------------------------------------')
...
try:
    ...
    proxy = requests.get('https://github.com/shipukhan2001/Sk_Shipu/blob/main/Sk_Shipu.txt').text.splitlines()
    v = 3.1
...
def m1():
    ...
    print(46*'-')
    print('IDZ SAVED IN SK-OK.txt : SK-CP.txt')
    print(46*'-')
